...
%package man
Summary: man components for the perl-Devel-OverloadInfo package.
Group: Default

%description man
man components for the perl-Devel-OverloadInfo package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Devel/OverloadInfo.pm
